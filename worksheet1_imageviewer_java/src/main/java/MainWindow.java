...
public class MainWindow
{
    ...
    public void show()
    {
        ...
        String url = new File(album.getFileName(0)).toURI().toString();
        ...
        captionWidget.setText(album.getCaption(0));
    ...
    */
    ...
    private void prevBtnHandler(ActionEvent event)
    {
        ...
        album.setIdx(album.getIdx()-1);
        String url = new File(album.getFileName(album.getIdx())).toURI().toString();
        imageWidget.setImage(new Image(url));
        captionWidget.setText(album.getCaption(album.getIdx()));
    }
